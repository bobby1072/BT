...
{
    internal class ActionToTime<TParam>(Action<TParam> action, IReadOnlyCollection<TParam> data) : IOperationTimer
    {
    ...
    internal class ActionToTime(Action action) : IOperationTimer
    {
