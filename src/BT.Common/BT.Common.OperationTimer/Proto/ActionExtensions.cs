...
namespace BT.Common.OperationTimer.Proto
{
    public static class ActionExtensions
    {
        ...
        /// </summary>
        public static TimeSpan Time<TParam>(this Action<TParam> action, TParam data)
        {
        ...
        /// </summary>
        public static TimeSpan Time<TParam>(this Action<TParam> action, IReadOnlyCollection<TParam> data)
        {
            var actionToTime = new ActionToTime<TParam>(action, data);
            return actionToTime.Run();
        }
        ...
        /// </param>
        public static async Task<TimeSpan> TimeAsync<TParam>(this Action<TParam> action, IReadOnlyCollection<TParam> data, bool awaitAllAtOnce = false)
        {
            var actionToTime = new ActionToTime<TParam>(action, data);
        ...
        /// </summary>
        public static async Task<TimeSpan> TimeAsync<TParam>(this Action<TParam> action, TParam data)
        {
            var actionToTime = new ActionToTime<TParam>(action, data);
        ...
        /// This method will asyncronously run the method and return a timespan for how long it took
        /// </summary>
        public static async Task<TimeSpan> TimeAsync(this Action action)
        {
            var actionToTime = new ActionToTime(action);
            return await actionToTime.RunAsync(false);
        }
