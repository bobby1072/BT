...
namespace BT.Common.FastArray.Tests.ProtoTests
{
    ...
    {
        private class FastArraySelectTestsFunctionalityClassData : TheoryData<IReadOnlyCollection<object>, Func<IEnumerable<object>, IEnumerable<object>>, Func<IEnumerable<object>, IEnumerable<object>>>
        {
            public FastArraySelectTestsFunctionalityClassData()
            {
        ...
        private class FastArraySelectAsyncTestsFunctionalityClassData : TheoryData<IReadOnlyCollection<object>, Func<IEnumerable<object>, IEnumerable<Task<object>>>, Func<IEnumerable<object>, IEnumerable<Task<object>>>>
        {
            public FastArraySelectAsyncTestsFunctionalityClassData()
            {
        ...
        [Theory]
        [ClassData(typeof(FastArraySelectTestsFunctionalityClassData))]
        ...
        [Theory]
        [ClassData(typeof(FastArraySelectAsyncTestsFunctionalityClassData))]
        ...
        private class FastArraySelectWhereTestsFunctionalityClassData : TheoryData<IReadOnlyCollection<object>, Func<IEnumerable<object>, IEnumerable<object>>, Func<IEnumerable<object>, IEnumerable<object>>>
        {
            public FastArraySelectWhereTestsFunctionalityClassData()
            {
        ...
        [Theory]
        [ClassData(typeof(FastArraySelectWhereTestsFunctionalityClassData))]
